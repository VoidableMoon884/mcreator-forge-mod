...
package net.mcreator.forgemod.block;
...
import net.mcreator.forgemod.world.teleporter.FarmworldTeleporter;
import net.mcreator.forgemod.world.teleporter.FarmworldPortalShape;

import java.util.Optional;

public class FarmworldPortalBlock extends NetherPortalBlock {
	public FarmworldPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<FarmworldPortalShape> optional = FarmworldPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new FarmworldPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			...
			} else if (entity.level.dimension() != ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("forgemod:farmworld"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("forgemod:farmworld")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new FarmworldTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
